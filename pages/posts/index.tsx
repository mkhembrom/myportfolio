            ...
            <div className="grid grid-rows-auto grid-cols-1 md:grid-cols-2 gap-8">
                <Link href="/posts/anicli" className="cursor-pointer" onMouseEnter={() => setTouch('anicli')} onMouseLeave={() => setTouch('')}>
                    <motion.div initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="w-full rounded-md">
                        ...
                        <motion.img initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="object-cover rounded-md w-full md:h-40 shadow-md" src="/anicli.png" alt="anicli" />
                ...
                <Link href="/posts/termux" className="cursor-pointer" onMouseEnter={() => setTouch('termux')} onMouseLeave={() => setTouch('')}>
                    <motion.div initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="w-full rounded-md">
                        <motion.img initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="object-cover rounded-md w-full md:h-40 shadow-md" src="/reactapp.png" alt="anicli" />
                        <div className="text-center">
