    ...
    return (
        <>
            <div className="w-full h-screen mt-10 flex flex-col items-center justify-center">
                ...
                <p className='w-[85%] xl:w-2/4 2xl:w-1/3 md:px-10 text-center text-[14px] md:text-[20px] text-center mx-auto italic my-4 text-white'>Thank you for taking the time to view my portfolio. If you have any feedback or just want to say hi, please use this contact form to send me a message.</p>

                <form onSubmit={handleSubmit} className="flex w-[85%] xl:w-2/4 2xl:w-1/3 flex-1 flex-col rounded-md justify-center items-center">
