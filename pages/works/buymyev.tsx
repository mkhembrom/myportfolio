    ...
    return (
        <div>
            ...
            <div className='w-1/2 mx-auto my-4 px-12'>
                <p className='text-[18px] px-10 tracking-wider	'>It's an Gallery artwork websites for grandiose Team to expand it bussines goal throught artworks. This website is active.</p>
