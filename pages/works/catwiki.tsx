    ...
    return (
        <div>
            ...
            <div className='w-1/2 mx-auto my-4 px-12'>
                <p className='text-[18px] tracking-wide'>Cat wiki website let you know about different cats breed.<br/> Over thousands of cat breed in this list.<br/> It's one of my personal project and fully responsive across devices and screens.</p>
                <div className='flex mt-5 items-center space-x-4'>
                    ...
                    <Link href="https://catmk.netlifyapp.com" className='text-[#d055a1] flex font-bold'>https://catmk.netlifyapp.com<BiLinkAlt color="#fff" /></Link>
                </div>
