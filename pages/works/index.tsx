        ...
        <div className="w-[80%] md:w-2/5 mx-auto">
            ...
            <div className="grid grid-rows-auto grid-cols-1 md:grid-cols-2 gap-8">
                <Link href="/works/grandiose" className="cursor-pointer" onMouseEnter={() => setTouch('grandiose')} onMouseLeave={() => setTouch('')}>
                    <motion.div initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="w-full rounded-md">
                        <motion.div variants={items} animate="active" className="w-full h-full">
                            <motion.img initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="object-cover rounded-md w-full md:h-40 shadow-md" src="/grandiose.png" alt="grandiose" />
                        </motion.div>
                ...
                <Link href="/works/buymyev" className="cursor-pointer" onMouseEnter={() => setTouch('buymyev')} onMouseLeave={() => setTouch('')}>
                    ...
                    <motion.div initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="rounded-md">
                        <motion.img initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="object-cover rounded-md md:h-40 shadow-md" src="/buymyevhome.png" alt="buymyev" />
                        <div className="text-center">
                ...
                <Link href="/works/catwiki" className="cursor-pointer" onMouseEnter={() => setTouch('catwiki')} onMouseLeave={() => setTouch('')}>
                    ...
                    <motion.div initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="rounded-md">
                        <motion.img initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="object-cover rounded-md md:h-40 shadow-md" src="/catweb.png" alt="grandiose" />
                        <div className="text-center">
                ...
                <Link href="/works/windbnb" className="cursor-pointer" onMouseEnter={() => setTouch('windbnb')} onMouseLeave={() => setTouch('')}>
                    ...
                    <motion.div initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="rounded-md">
                        <motion.img initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="object-cover rounded-md md:h-40 shadow-md" src="/windbnb.png" alt="grandiose" />
                        <div className="text-center">
            ...
            <div className="my-10">
                ...
                <div className="grid grid-rows-auto grid-cols-1 md:grid-cols-2 gap-8 my-10">
                    <motion.div initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="rounded-md">
                        <motion.video initial={{ filter: "blur(3px)" }} animate={{ filter: "blur(0px)" }} transition={{ duration: 1.5, delay: 0.4, type: "tween", ease: "easeOut" }} className="rounded-md md:h-40 object-cover shadow-md" autoPlay={true}>
