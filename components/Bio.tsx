    ...
    return (
        <div className="w-1/2 mx-auto">
            ...
            <div className="flex space-x-6">
                ...
                <p className="text-[18px]">Completed the Undergrad's Program in the <span onMouseEnter={() => setShow(true)} onMouseLeave={() => setShow(true)}><ComputerScienceEngineering  show={show} /></span> at Vinoba Bhave University (Guru Govind Singh Educational Societies Technical Campus)</p>
            </div>
            <div className="flex space-x-6">
                <h3 className="font-bold text-[18px] tracking-wide">2022</h3>
                <p className="text-[18px]">Worked at Luxeveda Brand & Tech Pvt. Ltd.</p>
            </div>
            </div>
