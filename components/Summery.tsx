...
const Experiance = ({ show, animationDuration }: any) => {
    ...
    return <RoughNotation type="highlight" animationDelay={2000} strokeWidth={1} color="yellow" animationDuration={animationDuration} show={show}>2 years</RoughNotation>;
}
